...
def compute_intersections(mean_lines, shape):
    (h, w) = shape
    intersections = []
...
def corner_detection(edges, intersections, shape, rect_size=50, show=False):
...
def compute_inout(class_image, line_params, shape, d_threshold=10):
...
def process_piece(image, **kwargs):
    ...
    try:
        ...
        out_dict['line_params'] = line_params
